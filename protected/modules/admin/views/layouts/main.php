...
<head>
	...
	<title><?php echo CHtml::encode($this->pageTitle).' (админка)'; ?></title>
</head>
...
<div class="container" id="page">
	...
	<div id="header">
		<div id="logo"><?php echo CHtml::encode(Yii::app()->name).' (админка)'; ?></div>
	</div><!-- header -->
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by @tumbayumba.<br/>
